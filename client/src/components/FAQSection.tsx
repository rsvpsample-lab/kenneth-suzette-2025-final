...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      icon: Hotel,
      answer: "Absolutely! There are several hotels and Airbnb options nearby in Taal, Batangas. Let us know if you'd like a little help with your booking — we'd be happy to assist!"
    },
    {
